  ...
  <div  class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <h4 style="font-weight: 500; " >You've Signed up Successfully!</h4>
    ...
    <div class="wrapper-left">
      ...
      <div class="grid-posts">
        ...
        <div class="wrapper-right">
          ...
          <div class="box-share">
            <p class="txt-share"><strong>What's Happening</strong></p>
          
          <div class="grid-share-new" style="margin-top: -13px">
